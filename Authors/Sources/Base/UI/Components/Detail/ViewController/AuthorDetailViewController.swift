...
extension AuthorDetailViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .avatar?:
            let avatarCell = tableView.dequeueReusableCell(AuthorAvatarTableViewCell.self, for: indexPath)

            avatarCell.authorView.viewModel = viewModel.authorViewModel

            return avatarCell

        case .resources?:
            let cell = tableView.dequeueReusableCell(AuthorResourcesTableViewCell.self, for: indexPath)
